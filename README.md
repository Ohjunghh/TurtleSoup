...
해당 프로젝트는 참가자들의 다양한 질문에 유연하게 답변하기 위해 LLM을 활용했으며, </br> 
**Gradio**, **Ollama**, **EEVE-korean-10.8B LLM**을 기반으로, 웹 환경에서 쉽게 즐길 수 있도록 제작되었습니다. </br> 
...
- **힌트 요청**
  - 사용자가 힌트를 요청하면, **직접적인 정답 노출 없이도 본질에 가까운 힌트**를 제공
    ...
    - 바다거북수프 시나리오 힌트 예시 : `💡 힌트 : 배고픔과 절망이 상상할 수 없는 선택을 불러일으킨다.`

---
https://6c4640c16979c017e3.gradio.live
