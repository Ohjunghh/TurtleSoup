...
**바다거북 수프**는 제한된 정보 속에서 **예/아니오로 답할 수 있는 질문**을 통해 사건의 진실을 추리하는 게임입니다.  </br> </br> 
게임 특성상 사용자는 매우 다양한 형태의 질문을 던지게 되며, 이에 대해 적절한 응답을 유연하게 제공해야 합니다. 이러한 다양하고 맥락적인 질의응답을 자연스럽게 처리하기 위해 LLM을 활용하게 되었습니다.</br></br> 
